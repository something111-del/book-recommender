...
with gr.Blocks() as dashboard:
    gr.Markdown("# 📚 Book Recommender - Zero-Shot Classification Demo")
    gr.Markdown("*Powered by facebook/bart-large-mnli for Fiction/Nonfiction classification*")
    
    # Statistics
    with gr.Accordion("📊 Classification Statistics", open=False):
...
if __name__ == "__main__":
    dashboard.launch(share=False, server_name="127.0.0.1", server_port=7860)
